...
\begin{frame}
    ...
    simply swapping the impurity and leaf model functions.
...
\begin{center}
Importances are measured only through the eyes of the model you are using.
They may not tell the entire nor the same story!
\end{center}
...
\end{pythoncode}
    ...
    \begin{figure}
       \centering
       \includegraphics[width=\textwidth]{./figures/dependence.png}
    \end{figure}
...
\begin{frame}
  ...
  % recap main strengths and weakness
\end{frame}
